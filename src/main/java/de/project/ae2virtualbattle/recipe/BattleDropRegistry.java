...
public class BattleDropRegistry {
    ...
    private static final TagKey<Item> BONES_TAG = TagKey.create(Registries.ITEM, ResourceLocation.fromNamespaceAndPath("c", "bones"));
    private static final TagKey<Item> RODS_TAG = TagKey.create(Registries.ITEM, ResourceLocation.fromNamespaceAndPath("c", "rods"));
    private static final TagKey<Item> SLIME_BALLS_TAG = TagKey.create(Registries.ITEM, ResourceLocation.fromNamespaceAndPath("c", "slime_balls"));
    private static final TagKey<Item> STRINGS_TAG = TagKey.create(Registries.ITEM, ResourceLocation.fromNamespaceAndPath("c", "strings"));
    private static final TagKey<Item> ENDER_PEARLS_TAG = TagKey.create(Registries.ITEM, ResourceLocation.fromNamespaceAndPath("c", "ender_pearls"));
    private static final TagKey<Item> SKULLS_TAG = TagKey.create(Registries.ITEM, ResourceLocation.fromNamespaceAndPath("c", "skulls"));
