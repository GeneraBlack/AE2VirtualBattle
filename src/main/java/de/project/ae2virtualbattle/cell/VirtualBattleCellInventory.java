...
public class VirtualBattleCellInventory implements IVirtualBattleCell {
    ...
    public VirtualBattleCellInventory(ItemStack stack, @Nullable ISaveProvider host, BattleCellTier tier) {
        this.stack = stack;
        this.host = host;
        this.tier = tier;
        this.loadCellItems();
    ...
    public long insert(AEKey what, long amount, Actionable mode, IActionSource source) {
        ...
        if (item.equals(configuredTarget)) {
            ...
            List<BattleDropEntry> drops = BattleDropRegistry.getDropEntries(configuredTarget, null);
            for (BattleDropEntry entry : drops) {
